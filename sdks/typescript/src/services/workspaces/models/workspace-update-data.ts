...
import {
  ...
  workspaceUpdateCreatedByData,
  workspaceUpdateCreatedByDataRequest,
...
/**
 * Zod schema for the WorkspaceUpdateData model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const workspaceUpdateData = z.lazy(() => {
  return z.object({
    id: z.number().optional(),
    topic: z.string().optional(),
    description: z.string().optional(),
    workspaceId: z.string().optional(),
    createdBy: workspaceUpdateCreatedByData.optional(),
 ...
 * @typedef  {WorkspaceUpdateData} workspaceUpdateData - Information about the workspace update. - Information about the workspace update.
 ...
 * @property {WorkspaceUpdateCreatedByData} - Information about the user that created the workspace update.
 ...
 */
export type WorkspaceUpdateData = z.infer<typeof workspaceUpdateData>;

/**
 * Zod schema for mapping API responses to the WorkspaceUpdateData application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const workspaceUpdateDataResponse = z.lazy(() => {
  return z
    .object({
      id: z.number().optional(),
      topic: z.string().optional(),
      description: z.string().optional(),
      workspaceId: z.string().optional(),
      createdBy: workspaceUpdateCreatedByDataResponse.optional(),
      updatedBy: z.number().optional(),
      createdAt: z.string().optional(),
      updatedAt: z.string().optional(),
      category: workspaceUpdateCategoryData.optional(),
...
/**
 * Zod schema for mapping the WorkspaceUpdateData application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const workspaceUpdateDataRequest = z.lazy(() => {
  return z
    .object({
      id: z.number().optional(),
      topic: z.string().optional(),
      description: z.string().optional(),
      workspaceId: z.string().optional(),
      createdBy: workspaceUpdateCreatedByDataRequest.optional(),
      updatedBy: z.number().optional(),
      createdAt: z.string().optional(),
      updatedAt: z.string().optional(),
      category: workspaceUpdateCategoryData.optional(),
