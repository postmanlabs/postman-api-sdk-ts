import { z } from 'zod';
import {
  GetApiCatalogServiceSpecificationLintsDataStatus,
  getApiCatalogServiceSpecificationLintsDataStatus,
} from './get-api-catalog-service-specification-lints-data-status';
...
export const getApiCatalogServiceSpecificationLintsData = z.lazy(() => {
  return z.object({
    ...
    timestamp: z.string(),
    status: getApiCatalogServiceSpecificationLintsDataStatus,
    issues: issues,
  });
});
