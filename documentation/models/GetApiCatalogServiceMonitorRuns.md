...
| :--- | :------------------------------------------------------------------------------ | :------- | :----------------------------------------------------- |
| meta | GetApiCatalogServiceMonitorRunsMeta                                             | ✅       | The response's meta information for paginated results. |
| data | [GetApiCatalogServiceMonitorRunsData](GetApiCatalogServiceMonitorRunsData.md)[] | ✅       | A list of monitor runs.                                |
