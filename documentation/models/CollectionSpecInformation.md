...
| state     | CollectionSpecInformationState | ❌       | The sync state of the collection and its API specification. |
...
| updatedBy | number                         | ❌       | The ID of the user who updated the collection.              |

# CollectionSpecInformationState
