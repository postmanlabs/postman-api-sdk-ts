...
(async () => {
  ...
  const variableInfoValue1 = 'eiusmod ullamco';
  ...
  const authAttributesValue = 'exercitati';
  ...
  const responseHeader1 = 'ipsum quis v';
...
(async () => {
  ...
  const variableInfoValue2 = 'laborum sunt do';
  ...
  const responseHeader2_3 = 'ea quis';
