...
(async () => {
  ...
  const variableInfoValue1 = 'Lorem';
...
(async () => {
  ...
  const variableInfoValue2 = 'nostrud ir';
  ...
  const responseHeader2_3 = 'cupidatat Lorem';
  ...
  const collectionVariableInfoValue = 'quis fugiat';
