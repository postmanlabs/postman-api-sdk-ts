...
(async () => {
  ...
  const variableInfoValue1 = 'aliqua ';
  ...
  const authAttributesValue = 'occaecat ';
  ...
  const responseHeader1 = 'irure lab';
...
(async () => {
  ...
  const variableInfoValue2 = 'anim labo';
  ...
  const responseHeader2_3 = 'laborum volu';
  ...
  const collectionVariableInfoValue = 'proident in mi';
