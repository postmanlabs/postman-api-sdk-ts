...
(async () => {
  ...
  const variableInfoValue1 = 'sit sint occaec';
  ...
  const authAttributesValue = 'proid';
...
(async () => {
  ...
  const variableInfoValue2 = 'laborum ea eu';
  ...
  const responseHeader2_3 = 'culpa labore';
