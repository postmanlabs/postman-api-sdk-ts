...
(async () => {
  ...
  const variableInfoValue1 = 'dolore anim ';
  ...
  const authAttributesValue = 'in cillum ';
  ...
  const responseHeader1 = 'labore nis';
...
(async () => {
  ...
  const variableInfoValue2 = 'voluptate id ';
  ...
  const responseHeader2_3 = 'ullamco m';
