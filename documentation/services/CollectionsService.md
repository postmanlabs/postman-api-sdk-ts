...
(async () => {
  ...
  const variableInfoValue1 = 'ullamco ';
  ...
  const authAttributesValue = 'exercitation ';
  ...
  const responseHeader1 = 'incididunt';
...
(async () => {
  ...
  const variableInfoValue2 = 'quis et';
  ...
  const responseHeader2_3 = 'minim ci';
