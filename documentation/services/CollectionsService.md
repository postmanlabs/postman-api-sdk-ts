...
(async () => {
  ...
  const variableInfoValue1 = 'Utcil';
  ...
  const authAttributesValue = 'dolore v';
  ...
  const responseHeader1 = 'commodo eli';
...
(async () => {
  ...
  const variableInfoValue2 = 'ut dolor ipsum ';
  ...
  const responseHeader2_3 = 'dolor quis ';
