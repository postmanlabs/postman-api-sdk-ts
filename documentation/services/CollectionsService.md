...
(async () => {
  ...
  const variableInfoValue1 = 'tempor ';
  ...
  const authAttributesValue = 'sit in ';
  ...
  const responseHeader1 = 'nonpariat';
...
(async () => {
  ...
  const responseHeader2_3 = 'ex commodo ';
