...
(async () => {
  ...
  const variableInfoValue1 = 'adcons';
  ...
  const authAttributesValue = 'proident lab';
...
(async () => {
  ...
  const variableInfoValue2 = 'voluptate eu o';
  ...
  const responseHeader2_3 = 'dolor magna';
