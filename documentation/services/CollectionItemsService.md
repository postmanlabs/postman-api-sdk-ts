...
```typescript
import { CreateFolder, PostmanApiSdk } from 'postman-api-sdk';
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.createCollectionFolder(
...
(async () => {
  ...
  const createRequestDataMode = 'raw';

  const requestDataType = 'text';
  ...
  const requestEventsListen = 'test';
  ...
  const data = await postmanApiSdk.collectionItems.createCollectionRequest(
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
    createRequest,
    {
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.createCollectionResponse(
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
    createCollectionResponseRequest,
    {
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.getCollectionFolder(
...
```typescript
import { PostmanApiSdk, UpdateFolder } from 'postman-api-sdk';
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.updateCollectionFolder(
    '65a99e60-8e0a-4b6e-b79c-7d8264cc5caa',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
    updateFolder,
  );
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.deleteCollectionFolder(
    '65a99e60-8e0a-4b6e-b79c-7d8264cc5caa',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
  );
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.getCollectionRequest(
...
(async () => {
  ...
  const updateRequestDataMode = 'raw';
  ...
  const data = await postmanApiSdk.collectionItems.updateCollectionRequest(
    'c82dd02c-4870-4907-8fcb-593a876cf05b',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
    updateRequest,
  );
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.deleteCollectionRequest(
    'c82dd02c-4870-4907-8fcb-593a876cf05b',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
  );
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.getCollectionResponse(
...
(async () => {
  ...
  const updateCollectionResponseDataMode = 'raw';
  ...
  const data = await postmanApiSdk.collectionItems.updateCollectionResponse(
    'cc364734-7dfd-4bfc-897d-be763dcdbb07',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
    updateCollectionResponse1,
  );
...
(async () => {
  ...
  const data = await postmanApiSdk.collectionItems.deleteCollectionResponse(
    'cc364734-7dfd-4bfc-897d-be763dcdbb07',
    '12ece9e1-2abf-4edc-8e34-de66e74114d2',
  );
