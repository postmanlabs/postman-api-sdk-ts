 ...
 * @typedef  {MonitorNotifications} monitorNotifications - Information about the monitor's notification settings. - Information about the monitor's notification settings.
 * @property {OnError[]}
 * @property {OnFailure[]}
 */
