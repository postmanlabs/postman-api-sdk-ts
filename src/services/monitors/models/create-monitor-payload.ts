...
/**
 * Zod schema for the CreateMonitorPayload model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const createMonitorPayload = z.lazy(() => {
  return z.object({
    name: z.string(),
 ...
 * @typedef {CreateMonitorPayload} createMonitorPayload
 ...
 */
export type CreateMonitorPayload = z.infer<typeof createMonitorPayload>;

/**
 * Zod schema for mapping API responses to the CreateMonitorPayload application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const createMonitorPayloadResponse = z.lazy(() => {
  return z
    .object({
      name: z.string(),
      active: z.boolean().optional(),
...
/**
 * Zod schema for mapping the CreateMonitorPayload application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const createMonitorPayloadRequest = z.lazy(() => {
  return z
    .object({
      name: z.string(),
      active: z.boolean().optional(),
