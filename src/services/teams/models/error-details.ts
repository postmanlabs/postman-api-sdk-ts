 ...
 * @typedef  {ErrorDetails} errorDetails - An explanation about the problem. - An explanation about the problem.
 * @property {ErrorDetailsError} - Information about the error.
 */
