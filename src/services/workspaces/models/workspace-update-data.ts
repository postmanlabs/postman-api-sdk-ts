 ...
 * @typedef {WorkspaceUpdateData} workspaceUpdateData
 ...
 * @property {WorkspaceUpdateCreatedByData} createdBy - Information about the user that created the workspace update.
