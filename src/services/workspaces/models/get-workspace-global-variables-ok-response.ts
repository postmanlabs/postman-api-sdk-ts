...
/**
 * Zod schema for the GetWorkspaceGlobalVariablesOkResponse model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const getWorkspaceGlobalVariablesOkResponse = z.lazy(() => {
  return z.object({
...
/**
 * Zod schema for mapping API responses to the GetWorkspaceGlobalVariablesOkResponse application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getWorkspaceGlobalVariablesOkResponseResponse = z.lazy(() => {
  return z
    .object({
...
/**
 * Zod schema for mapping the GetWorkspaceGlobalVariablesOkResponse application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getWorkspaceGlobalVariablesOkResponseRequest = z.lazy(() => {
  return z
    .object({
