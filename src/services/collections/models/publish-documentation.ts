 ...
 * @property {string} - The unique ID of the environment to publish with the documentation. The initial values of all variables are published with the documentation. Make certain they don't contain sensitive information such as passwords or tokens.
 ...
 * @property {DocumentationLayout} - The documentation's default layout style:
