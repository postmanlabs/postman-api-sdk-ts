 ...
 * @typedef {CollectionVariableInfo} collectionVariableInfo
 * @property {string} key - The variable's key (name).
 * @property {CollectionVariableInfoValue} value - The key's value.
 * @property {boolean} disabled - If true, the variable is not enabled.
 */
