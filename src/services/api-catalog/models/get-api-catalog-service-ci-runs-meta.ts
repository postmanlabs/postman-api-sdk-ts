...
/**
 * Zod schema for the GetApiCatalogServiceCiRunsMeta model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const getApiCatalogServiceCiRunsMeta = z.lazy(() => {
  return z.object({
 ...
 * @typedef  {GetApiCatalogServiceCiRunsMeta} getApiCatalogServiceCiRunsMeta - The response's meta information for paginated results. - The response's meta information for paginated results.
 ...
 */
export type GetApiCatalogServiceCiRunsMeta = z.infer<typeof getApiCatalogServiceCiRunsMeta>;

/**
 * Zod schema for mapping API responses to the GetApiCatalogServiceCiRunsMeta application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getApiCatalogServiceCiRunsMetaResponse = z.lazy(() => {
  return z
    .object({
      nextCursor: z.string().nullable(),
      limit: z.number(),
...
/**
 * Zod schema for mapping the GetApiCatalogServiceCiRunsMeta application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getApiCatalogServiceCiRunsMetaRequest = z.lazy(() => {
  return z
    .object({
      nextCursor: z.string().nullable(),
      limit: z.number(),
