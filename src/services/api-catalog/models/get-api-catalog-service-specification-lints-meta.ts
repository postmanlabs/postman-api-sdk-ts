...
/**
 * Zod schema for the GetApiCatalogServiceSpecificationLintsMeta model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const getApiCatalogServiceSpecificationLintsMeta = z.lazy(() => {
  return z.object({
    ...
    passedRuns: z.number(),
    failedRuns: z.number(),
    conformanceRatePct: z.number(),
  });
});

/**
 * The response's meta information for paginated results.
 * @typedef  {GetApiCatalogServiceSpecificationLintsMeta} getApiCatalogServiceSpecificationLintsMeta - The response's meta information for paginated results. - The response's meta information for paginated results.
 ...
 */
export type GetApiCatalogServiceSpecificationLintsMeta = z.infer<
  typeof getApiCatalogServiceSpecificationLintsMeta
>;

/**
 * Zod schema for mapping API responses to the GetApiCatalogServiceSpecificationLintsMeta application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getApiCatalogServiceSpecificationLintsMetaResponse = z.lazy(() => {
  return z
    .object({
      nextCursor: z.string().nullable(),
      limit: z.number(),
    ...
    .transform((data) => ({
      ...
      conformanceRatePct: data['conformanceRatePct'],
    }));
});

/**
 * Zod schema for mapping the GetApiCatalogServiceSpecificationLintsMeta application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const getApiCatalogServiceSpecificationLintsMetaRequest = z.lazy(() => {
  return z
    .object({
      nextCursor: z.string().nullable(),
      limit: z.number(),
