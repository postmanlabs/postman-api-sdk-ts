...
/**
 * Zod schema for the UpdateMockMockConfig model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const updateMockMockConfig = z.lazy(() => {
  return z.object({
...
/**
 * Zod schema for mapping API responses to the UpdateMockMockConfig application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const updateMockMockConfigResponse = z.lazy(() => {
  return z
    .object({
      serverResponseId: z.string().optional().nullable(),
    })
...
/**
 * Zod schema for mapping the UpdateMockMockConfig application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const updateMockMockConfigRequest = z.lazy(() => {
  return z
    .object({
      serverResponseId: z.string().optional().nullable(),
    })
