...
/**
 * Zod schema for the SecretsLocationsData model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const secretsLocationsData = z.lazy(() => {
  return z.object({
 ...
 * @typedef {SecretsLocationsData} secretsLocationsData
 ...
 */
export type SecretsLocationsData = z.infer<typeof secretsLocationsData>;

/**
 * Zod schema for mapping API responses to the SecretsLocationsData application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const secretsLocationsDataResponse = z.lazy(() => {
  return z
    .object({
      isResourceDeleted: z.boolean().optional(),
      leakedBy: z.number().optional(),
...
/**
 * Zod schema for mapping the SecretsLocationsData application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const secretsLocationsDataRequest = z.lazy(() => {
  return z
    .object({
      isResourceDeleted: z.boolean().optional(),
      leakedBy: z.number().optional(),
