...
/**
 * Zod schema for the DetectedSecretsData model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const detectedSecretsData = z.lazy(() => {
  return z.object({
...
/**
 * @typedef {DetectedSecretsData} detectedSecretsData
 ...
 * @property {DetectedSecretsDataWorkspaceVisibility} workspaceVisibility - The workspace's [visibility setting](https://learning.postman.com/docs/collaborating-in-postman/using-workspaces/managing-workspaces/#changing-workspace-visibility).
 ...
 */
export type DetectedSecretsData = z.infer<typeof detectedSecretsData>;

/**
 * Zod schema for mapping API responses to the DetectedSecretsData application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const detectedSecretsDataResponse = z.lazy(() => {
  return z
    .object({
      detectedAt: z.string().optional(),
      secretType: z.string().optional(),
...
/**
 * Zod schema for mapping the DetectedSecretsData application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const detectedSecretsDataRequest = z.lazy(() => {
  return z
    .object({
      detectedAt: z.string().optional(),
      secretType: z.string().optional(),
