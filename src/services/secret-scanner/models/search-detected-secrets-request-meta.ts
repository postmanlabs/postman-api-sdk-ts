...
/**
 * Zod schema for the SearchDetectedSecretsRequestMeta model.
 * Defines the structure and validation rules for this data type.
 * This is the shape used in application code - what developers interact with.
 */
export const searchDetectedSecretsRequestMeta = z.lazy(() => {
  return z.object({
...
/**
 * Zod schema for mapping API responses to the SearchDetectedSecretsRequestMeta application shape.
 * Handles any property name transformations from the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const searchDetectedSecretsRequestMetaResponse = z.lazy(() => {
  return z
    .object({
      limit: z.number().optional(),
      nextCursor: z.string().optional().nullable(),
...
/**
 * Zod schema for mapping the SearchDetectedSecretsRequestMeta application shape to API requests.
 * Handles any property name transformations required by the API schema.
 * If property names match the API schema exactly, this is identical to the application shape.
 */
export const searchDetectedSecretsRequestMetaRequest = z.lazy(() => {
  return z
    .object({
      limit: z.number().optional(),
      nextCursor: z.string().optional().nullable(),
