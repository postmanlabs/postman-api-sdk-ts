 ...
 * @typedef  {UpdateCollectionResponseResponseCode} updateCollectionResponseResponseCode - The response's HTTP response code information. - The response's HTTP response code information.
