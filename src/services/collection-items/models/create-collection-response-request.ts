 ...
 * @typedef {CreateCollectionResponseRequest} createCollectionResponseRequest
 * @property {string} name - The response's name. It is recommended that you pass the `name` property in the request body. If you do not, the system uses a null value. As a result, this creates a response with a blank name.
 ...
 * @property {CollectionResponseCreatedDataMode} dataMode - The associated request body's data mode.
 ...
 * @property {CollectionResponseCreatedResponseCode} responseCode - The response's HTTP response code information.
